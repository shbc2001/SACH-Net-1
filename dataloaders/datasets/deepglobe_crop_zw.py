...
from dataloaders import custom_transforms_4 as tr
...
class Segmentation(Dataset):
    ...
    def __init__(self,
        ...
        self._con_dir = os.path.join(self._base_dir, 'crops', 'connect_8_d1_zw')
        self._con_d1_dir = os.path.join(self._base_dir, 'crops', 'connect_8_d3_zw')
